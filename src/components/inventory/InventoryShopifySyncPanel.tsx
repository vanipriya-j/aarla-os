    ...
    <div className="space-y-4" data-testid="inventory-shopify-sync-panel">
      <div className="rounded-xl border border-border bg-white p-4 space-y-3">
        ...
        <p className="text-xs text-charcoal/50">
          Compare / Pull use the same Shopify qty field as Import base inventory (no locations
          call). Push needs live <code>write_inventory</code> + <code>read_locations</code> on the
          store token — a new app version alone is not enough; reinstall, or clear a stale{" "}
