...
/** Legacy hamper brief generator kept as a secondary Story tab. */
export function StoryHamperBrief() {
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Field label="Personalisation">
            <input
              ...
              defaultValue="First-name thank-you cards for 42 lead teachers"
            />
          </Field>
        </div>
        <div className="pt-2">
