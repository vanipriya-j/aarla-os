 ...
 * Used by `npm run db:seed` and the browser `/setup` bootstrap.
 */
...
async function truncateAll(client: DbClient) {
...
export async function runSeedDemo(client: DbClient): Promise<void> {
