...
export const products: Product[] = [
  ...
  },
  {
    id: "prod-kolam-art",
    sku: "AAR-ART-KOL-12",
    title: "Kolam Framed Art",
    category: "Framed art",
    world: "Chennai",
    story: "Framed kolam geometry for the wall.",
    variants: [
      { id: "var-art-08", label: "8x10 frame", sku: "AAR-ART-KOL-08", options: { Format: "8x10" } },
      { id: "var-art-12", label: "12x16 frame", sku: "AAR-ART-KOL-12", options: { Format: "12x16" } },
      { id: "var-art-16", label: "16x20 frame", sku: "AAR-ART-KOL-16", options: { Format: "16x20" } },
    ],
    sellingPrice: 2200,
    cost: 890,
    velocity: "Slow",
  ...
  },
  {
    id: "prod-chennai-tee",
    sku: "AAR-TEE-CHN-01",
    title: "Chennai Kolam Tee",
    category: "T-Shirts",
    world: "Chennai",
    story: "A kolam line traced across cotton — everyday wear for the Chennai grid.",
    variants: [
      { id: "var-tee-ind-s", label: "Indigo — S", sku: "AAR-TEE-CHN-01-IND-S", options: { Size: "S", Colour: "Indigo" } },
      { id: "var-tee-ind-m", label: "Indigo — M", sku: "AAR-TEE-CHN-01-IND-M", options: { Size: "M", Colour: "Indigo" } },
      { id: "var-tee-ind-l", label: "Indigo — L", sku: "AAR-TEE-CHN-01-IND-L", options: { Size: "L", Colour: "Indigo" } },
      { id: "var-tee-mus-s", label: "Mustard — S", sku: "AAR-TEE-CHN-01-MUS-S", options: { Size: "S", Colour: "Mustard" } },
      { id: "var-tee-mus-m", label: "Mustard — M", sku: "AAR-TEE-CHN-01-MUS-M", options: { Size: "M", Colour: "Mustard" } },
      { id: "var-tee-mus-l", label: "Mustard — L", sku: "AAR-TEE-CHN-01-MUS-L", options: { Size: "L", Colour: "Mustard" } },
    ],
    sellingPrice: 799,
    cost: 310,
    velocity: "Fast",
    status: "Active",
    ideaOrigin: "Chennai World — everyday wear",
    designedDate: "2026-07-20",
  },
  {
    id: "prod-welcome-kit",
    sku: "AAR-KIT-WEL-01",
