...
Business state persists in **PostgreSQL** (local Docker for development; **Supabase Cloud** for Vercel). Optional **role-based cookie auth** (`admin` full access, `crm` outreach only) — see `docs/auth.md`.
